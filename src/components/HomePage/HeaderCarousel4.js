...
<circle cx="0" cy="0" r="300" fill="#ffffff" opacity="0.9"/>
     ...
     </div><div className="container mx-auto mt-20 px-4 sm:px-2 md:px-8 lg:px-12 py-4 sm:py-8 md:py-12 lg:py-16 flex flex-col justify-center relative z-10">
        {/* Progress Bar */}
        <div className="h-1 bg-gray-200 relative overflow-hidden flex-shrink-0">
          <div 
            className="h-full bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 transition-all duration-1000 ease-out relative"
...
<div className="flex-1 flex flex-col items-center justify-center gap-6">
  ...
  {/* Button Content */}
  <button className="relative flex items-center bg-blue-600 p-3 rounded-full justify-center gap-3 cursor-pointer">
    <Zap className="w-6 h-6 text-white" />
    <span className="bg-white bg-clip-text text-transparent font-extrabold">
      Start Quiz
    </span>
